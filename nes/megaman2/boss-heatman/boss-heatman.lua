-- Mega Man 2 — Heat Man Boss Fight (Buster Only)
-- Loaded loadout: full HP (28), buster equipped, no subweapon. Defeat
-- Heat Man as fast as possible. Die once and the run is over.
--
-- Mirrors boss-metalman / crashman-buster-only — same freeze trick,
-- same time-grade thresholds, same death detector.
--
...
-- ---------------------------------------------------------------------------
challenge.run{
    savestate           = "savestates/boss-heatman.state",
