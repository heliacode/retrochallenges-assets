-- FlawlessNES — Castlevania Block 2 (Second Level), No Damage
-- ===========================================================
-- Clear Block 2 and defeat its boss (Medusa) without taking a hit.
...
--      predicate would fire on frame 1.
--
...
-- ---------------------------------------------------------------------------
challenge.run{
    savestate           = "savestates/flawlessnes-secondlevel.State",
