-- FlawlessNES — Castlevania Death Corridor (reach the Death fight), No Damage
-- ==========================================================================
-- Run the scrolling corridor up to Death's arena without taking a hit.
...
--   Win  = the screen stops scrolling — i.e. you reach the Death boss fight.
--          Castlevania locks scrolling for a boss via the Boss-Screen byte
--          ($0048), which reads 0 during the corridor and flips non-zero the
...
-- ---------------------------------------------------------------------------
challenge.run{
    savestate           = "savestates/flawlessnes-death-corridor.State",
    ...
    -- Win = the screen locked for the boss (reached Death's arena) AND still
