-- FlawlessNES — Castlevania Frankenstein & Igor, No Damage
-- ========================================================
-- No-hit fight against Frankenstein's monster (and Igor, the flea-man on his
-- shoulder) — the Block 4 boss. FlawlessNES rules: you don't FAIL on a hit;
...
-- DOES end the run. This savestate starts in the boss room, so the
-- boss-engaged latch trips immediately and the win fires the moment the
-- boss's HP reaches 0 (killing Frankenstein ends the fight).
--
...
local BOSS_HEALTH  = 0x01A9   -- Boss Real Health (Frankenstein's HP)
...
-- ---------------------------------------------------------------------------
challenge.run{
    savestate           = "savestates/flawlessnes-frank-n-beans.State",
