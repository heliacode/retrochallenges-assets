-- FlawlessNES — Castlevania Medusa, No Damage
-- ===========================================
-- No-hit fight against Medusa (Block 2 boss). FlawlessNES rules: you don't
-- FAIL on a hit — every hit chips your score per the fixed table (identical
-- for every FlawlessNES challenge):
--
--   Hits  Rank      Score
--   0     Flawless  5000
--   1     A         3500
...
-- DOES end the run. This savestate starts in Medusa's boss room, so the
-- boss-engaged latch trips immediately and the win fires the moment her HP
-- reaches 0.
--
...
local BOSS_HEALTH  = 0x01A9   -- Boss Real Health (Medusa HP)
...
-- ---------------------------------------------------------------------------
challenge.run{
    savestate           = "savestates/flawlessnes-medusaboss.State",
