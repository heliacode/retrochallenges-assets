-- FlawlessNES — Castlevania Death (the boss), No Damage
-- =====================================================
-- No-hit fight against Death / the Grim Reaper (Block 5 boss). FlawlessNES
...
-- DOES end the run. This savestate starts in Death's boss room, so the
-- boss-engaged latch trips immediately and the win fires the moment his HP
-- reaches 0.
--
...
local BOSS_HEALTH  = 0x01A9   -- Boss Real Health (Death's HP)
...
-- ---------------------------------------------------------------------------
challenge.run{
    savestate           = "savestates/flawlessnes-deathboss.State",
